...
for f in growth.png aligned-cases.png aligned-deaths.png active-log.png active-prop-log.png projections-0.png projections-1.png projections-2.png projections-3.png ; do
    ${CP}               "output/${f}" "${DST}/${f}"
